    ...
    <>
      ...
      <div className="max-w-[1300px] mx-auto my-14 px-5 lg:px-0">
        ...
        <div className="flex flex-col gap-6 text-lg text-base-content">
          <p>
            This Cookie Policy explains how SportSync uses cookies and similar
            technologies to improve your browsing experience on our Platform.
          </p>
          <p>
            ...
            website. They help remember your preferences, improve website
          ...
          <p>
            ...
            <ul className="list-disc pl-5">
              <li>
                ...
                such as enabling secure logins and ticket purchases.
              </li>
              <li>
                Performance Cookies: Collect anonymous data about how visitors
                use our Platform to help improve functionality.
              </li>
              <li>
              ...
              <li>
                Marketing Cookies: Track browsing habits to provide relevant
                advertising.
              </li>
            </ul>
          </p>
          ...
          <p>
            ...
            analytics or payment gateways.
          </p>
          <p>
            <span className="text-base-content font-bold">5. Changes</span>
            <br />
            We may update this Cookie Policy at any time. Updates will be posted

      ...
      <div className="max-w-[1300px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="border border-[#e2e8f0] bg-white rounded-xl shadow-sm">
          <div className="relative">
            <img src={basketImg} alt="" className="w-full h-[200px] object-cover rounded-t-xl"/>
            <div className="hero-overlay absolute top-0 bottom-auto"></div>
            <h2 className="text-2xl font-bold text-white absolute z-10 bottom-5 left-5 ">Basketball</h2>
          </div>
          ...
          <div className="px-5 pb-5">
            ...
            <p className="text-sm text-gray-500">Growing community with regular competitions</p>
            </div>
          </div>
        </div>
        <div className="border border-[#e2e8f0] bg-white rounded-xl shadow-sm">
          <div className="relative">
            <img src={runImg} alt="" className="w-full h-[200px] object-cover rounded-t-xl"/>
            <div className="hero-overlay absolute top-0 bottom-auto"></div>
            <h2 className="text-2xl font-bold text-white absolute z-10 bottom-5 left-5 ">Running</h2>
          </div>
          <div className="px-5 pt-6 flex gap-14 justify-center items-center">
            <div className="flex flex-col items-center">
              <LuUsers size="24px" className="text-orange-500"/>
        ...
        <div className="border border-[#e2e8f0] bg-white rounded-xl shadow-sm">
          <div className="relative">
            <img src={tennisImg} alt="" className="w-full h-[200px] object-cover rounded-t-xl"/>
            <div className="hero-overlay absolute top-0 bottom-auto"></div>
            <h2 className="text-2xl font-bold text-white absolute z-10 bottom-5 left-5 ">Tennis</h2>
          </div>
          <div className="px-5 pt-6 flex gap-14 justify-center items-center">
            <div className="flex flex-col items-center">
              <LuUsers size="24px" className="text-orange-500"/>
        ...
        <div className="border border-[#e2e8f0] bg-white rounded-xl shadow-sm">
          <div className="relative">
            <img src={swimImg} alt="" className="w-full h-[200px] object-cover rounded-t-xl"/>
            <div className="hero-overlay absolute top-0 bottom-auto"></div>
            <h2 className="text-2xl font-bold text-white absolute z-10 bottom-5 left-5 ">Swimming</h2>
          </div>
          <div className="px-5 pt-6 flex gap-14 justify-center items-center">
            <div className="flex flex-col items-center">
              <LuUsers size="24px" className="text-orange-500"/>
        ...
        <div className="border border-[#e2e8f0] bg-white rounded-xl shadow-sm">
          <div className="relative">
            <img src={cycleImg} alt="" className="w-full h-[200px] object-cover rounded-t-xl"/>
            <div className="hero-overlay absolute top-0 bottom-auto"></div>
            <h2 className="text-2xl font-bold text-white absolute z-10 bottom-5 left-5 ">Cycling</h2>
          </div>
          <div className="px-5 pt-6 flex gap-14 justify-center items-center">
            <div className="flex flex-col items-center">
              <LuUsers size="24px" className="text-orange-500"/>
        ...
        <div className="border border-[#e2e8f0] bg-white rounded-xl shadow-sm">
          <div className="relative">
            <img src={volleyballImg} alt="" className="w-full h-[200px] object-cover rounded-t-xl"/>
            <div className="hero-overlay absolute top-0 bottom-auto"></div>
            <h2 className="text-2xl font-bold text-white absolute z-10 bottom-5 left-5 ">Volleyball</h2>
          </div>
          <div className="px-5 pt-6 flex gap-14 justify-center items-center">
            <div className="flex flex-col items-center">
              <LuUsers size="24px" className="text-orange-500"/>

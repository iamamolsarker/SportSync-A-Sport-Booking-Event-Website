    ...
    <div className="bg-red-50 dark:bg-gray-900 px-5  md:px-1 py-14">
      <div className="w-full md:max-w-1/3 mx-auto text-center mb-8">
        ...
        <p className="text-lg font-medium text-base-content">
          Join thousands of satisfied athletes who trust SportSync for their
          event booking needs
        </p>
      </div>
      <div className="max-w-[1300px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="p-5 border border-[#e2e8f0] bg-white rounded-xl shadow-sm">
          ...
          <p className="text-gray-600 italic my-4">
            "SportSync made it incredibly easy to find and register for
            marathons in my area. The platform is intuitive and brilliant the
            event organization is top-notch in all way!"
          </p>
        ...
        <div className="p-5 border border-[#e2e8f0] bg-white rounded-xl shadow-sm">
          <LuQuote size="32px" className="text-orange-500" />
          <p className="text-gray-600 italic my-4">
            "I've participated in multiple basketball tournaments through
            SportSync. The booking process is seamless and the events are
            well-managed."
          </p>
          <div className="flex gap-0.5 text-yellow-500">
            <FaStar />
        ...
        <div className="p-5 border border-[#e2e8f0] bg-white rounded-xl shadow-sm">
          <LuQuote size="32px" className="text-orange-500" />
          <p className="text-gray-600 italic my-4">
            As a tennis player, I love how SportSync connects me with local
            tournaments. The variety of events and skill levels is perfect for
            everyone."
          </p>
          <div className="flex gap-0.5 text-yellow-500">
            <FaStar />
        ...
        <div className="p-5 border border-[#e2e8f0] bg-white rounded-xl shadow-sm">
          <LuQuote size="32px" className="text-orange-500" />
          <p className="text-gray-600 italic my-4">
            "Managing cycling events has never been easier. SportSync provides
            all the tools we need to organize successful competitions. The
            Platform is so good to manage. "
          </p>
          <div className="flex gap-0.5 text-yellow-500">
            <FaStar />
            <FaStar />

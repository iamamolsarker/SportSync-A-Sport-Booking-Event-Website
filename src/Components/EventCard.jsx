...
const EventCard = ({event}) => {
    const {eventName, eventType,  description, eventImage,   _id} = event;
    return (
        <div className='rounded-xl border border-gray-300'>
            <div className='relative'>
                <img src={eventImage} alt="" className='w-full h-[180px] object-cover rounded-t-xl' />
            ...
            <div className='p-5'>
                ...
                <p className='text-sm text-base-content my-5'>{description}</p>
